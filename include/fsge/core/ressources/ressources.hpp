#ifndef _FSGE_CORE_RESSOURCES_TYPESENUM_HPP_INCLUDED
#define _FSGE_CORE_RESSOURCES_TYPESENUM_HPP_INCLUDED

#include <type_traits>
#include <tuple>

#define RegisterAsRessource(RESSOURCE) [[maybe_unused]] constinit const static bool __fsge_ressource_declaration_hack = (fsge::Ressources::declare<RESSOURCE>(), true)
