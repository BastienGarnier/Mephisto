#ifndef _FSGE_CORE_COMPONENTS_TYPESENUM_HPP_INCLUDED
#define _FSGE_CORE_COMPONENTS_TYPESENUM_HPP_INCLUDED

#include <type_traits>
#include <tuple>

#define RegisterAsComponent(COMPONENT) [[maybe_unused]] constinit const static bool __fsge_component_declaration_hack = (fsge::Components::declare<COMPONENT>(), true)
